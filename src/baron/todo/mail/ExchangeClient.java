...
public class ExchangeClient {
    ...
    public boolean sendExchange() {
        ...
        try {
           ...
           System.out.println("An exception occured while creating the uri for exchange service."+ex.getMessage());
            return false;
        }
        ...
        try {
            ...
            System.out.println("An exception occured while setting the email message."+ex.getMessage());
            return false;
        }
        ...
        try {
            ...
            System.out.println("An exception occured while sstting the TO recipient(" + recipientTo + ")."+ex.getMessage());
            return false;
        }
        ...
        for (String recipient : recipientCc) {
            try {
                ...
                System.out.println("An exception occured while sstting the CC recipient(" + recipient + ")."+ex.getMessage());
                return false;
            }
        }
        ...
        for (String recipient : recipientBcc) {
            try {
                ...
                System.out.println("An exception occured while sstting the BCC recipient(" + recipient + ")."+ex.getMessage());
                return false;
            }
        }
        ...
        for (String attachmentPath : attachments) {
            try {
                ...
                System.out.println("An exception occured while setting the attachment."+ex.getMessage());
                return false;
            }
        }
        ...
        try {
            ...
            System.out.println("An exception occured while sending an email."+ex.getMessage());
            return false;
        }
